<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}" class="cc-stack-4">
        @csrf
        ...
        <div>
            ...
            <x-text-input id="email" class="mt-1" type="email" name="email" :value="old('email', $request->email)" autofocus autocomplete="username" />
